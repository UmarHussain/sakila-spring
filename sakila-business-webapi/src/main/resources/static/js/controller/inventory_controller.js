				...
				[
						...
						function($scope, InventoryService, FilmService) {
								...
								InventoryService
										...
										.then(
												...
												function(errResponse) {
													console
															.error('Error while fetching inventories');
												})
							};
							...
							self.createInventory = function(inventory) {
								InventoryService
										...
										.then(
												...
												function(errResponse) {
													console
															.error('Error while creating Actor.');
												});
							}
							...
							self.deleteInventory = function(inventoryId) {
								InventoryService
										...
										.then(
												...
												function(errResponse) {
													console
															.error('Error while deleting Inventory.');
												});
							};
							...
							self.fetchAllFilms = function() {
								FilmService
										...
										.then(
												...
												function(errResponse) {
													console
															.error('Error while fetching films');
												})
							};
													...
													InventoryService
															...
															.then(
																	...
																	function(
																			errResponse) {
																		console
																				.error('Error while getting Inventories by film');
																	});
												});
							}
							...
							self.addInventory = function(film) {
								console.log('Inventory to be add for film : ',
										film);
								// film.quantity++;
								// TODO
								var currentFilm = {
