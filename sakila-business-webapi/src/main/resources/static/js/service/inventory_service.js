						...
						function($http, $q) {
							...
							return {
								fetchAllInventories : function() {
									return $http
											.get(
													'http://localhost:8080/inventory/store/1')
											.then(
													function(response) {
								...
								getInventoriesByFilm : function(filmId) {
									return $http
											.get(
													'http://localhost:8080/inventory/film/'
															+ filmId)
											.then(
													function(response) {
														return response.data;
													...
													function(errResponse) {
														console
																.error('Error while fetching inventories by film');
														return $q
																.reject(errResponse);
													});
								},
								...
								updateInventory : function(inventory,
									...
									return $http
											.post(
													'http://localhost:8080/inventoryUpdate/',
													actor)
											.then(
													function(response) {
														return response.data;
								...
								deleteInventory : function(inventoryId) {
									return $http
											.get(
													'http://localhost:8080/inventoryDelete/'
															+ inventoryId)
											.then(
													function(response) {
														return response.data;
