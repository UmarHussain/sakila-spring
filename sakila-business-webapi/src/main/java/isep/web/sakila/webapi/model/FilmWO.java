...
public class FilmWO extends WebObject {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1082560759971419893L;
	...
	public String toString() {
		return "FilmWO [filmId=" + filmId + ", title=" + title + ", description=" + description + ", filmActors="
				+ filmActors + ", filmCategories=" + filmCategories + ", language1=" + language1 + ", language2="
				+ language2 + ", length=" + length + ", releaseYear=" + releaseYear + ", rentalDuration="
				+ rentalDuration + ", rentalRate=" + rentalRate + ", rentalCost=" + rentalCost + ", specialFeatures="
				+ specialFeatures + "]";
	}
